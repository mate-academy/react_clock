...
![How to enable verbose level](./readme-fi
les/enable-verbose-level.png)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://U-Ra-All.github.io/react_clock/) and add it to the PR description.
