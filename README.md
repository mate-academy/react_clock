[DEMO LINK](https://artemvlasiuk.github.io/react_clock/)
# React Clock
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://artemvlasiuk.github.io/react_clock/) and add it to the PR description.
